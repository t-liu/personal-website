...
Webflow.require('ix2').init(
  {
	"events": {
		"e-52": {
			...
			"target": {
				"id": "620e9742511d44d4f612b7d1|b4b6740e-da39-221d-6f6b-2f880cf6208a",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-54": {
			...
			"target": {
				"id": "620e9742511d44d4f612b7d1|b4b6740e-da39-221d-6f6b-2f880cf6210a",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-56": {
			...
			"mediaQueries": ["main"],
			"target": {
				"id": "620e9742511d44d4f612b7d1|b4b6740e-da39-221d-6f6b-2f880cf62086",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-60": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "620e9742511d44d4f612b7d1|b4b6740e-da39-221d-6f6b-2f880cf62101",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-67": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "620e9742511d44d4f612b7d1|b4b6740e-da39-221d-6f6b-2f880cf620f9",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-69": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "620e9742511d44d4f612b7d1|b4b6740e-da39-221d-6f6b-2f880cf62119",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-73": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "620e9742511d44d4f612b7d1|b4b6740e-da39-221d-6f6b-2f880cf620c6",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-75": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "620e9742511d44d4f612b7d1|b4b6740e-da39-221d-6f6b-2f880cf620ed",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-81": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "620e9742511d44d4f612b7d1|b4b6740e-da39-221d-6f6b-2f880cf620f7",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-85": {
			...
			"mediaQueries": ["main"],
			"target": {
				"id": "620e9742511d44d4f612b7d1|c537b552-c0f1-e924-8250-b7747af768a2",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-88": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "620e9742511d44d4f612b7d1|c537b552-c0f1-e924-8250-b7747af768ab",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-206": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "620e9742511d44c31912b7cc|5132607a-cc83-4a67-5f6d-5761205ad12e",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-208": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "620e9742511d44c31912b7cc|5132607a-cc83-4a67-5f6d-5761205ad130",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-327": {
			...
			"target": {
				...
				"originalId": "620e9742511d44c31912b7cc|4fe0b6d8-63a8-bc4b-8909-61c0239ba2b6",
				"appliesTo": "CLASS"
			},
			"targets": [{
				"selector": ".project__container",
		...
		"e-328": {
			...
			"target": {
				"appliesTo": "ELEMENT",
				"styleBlockIds": [],
				"id": "e0cac5db-cb5e-d588-1282-77551bef9a89"
			},
			"targets": [],
			"config": {
				"loop": false,
		...
		"e-329": {
			...
			"createdOn": 1645675167005
		}
	},
	"actionLists": {
		"a-5": {
			"id": "a-5",
			"title": "dropdown-menu-mobile",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-5-n",
				...
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							"useEventTarget": true,
							"id": "f6920c25-0e5a-b2df-710b-22dc5d023dce"
						},
						"zValue": -180,
						"xUnit": "DEG",
						"yUnit": "DEG",
			...
			"createdOn": 1527099277969
		},
		"a-6": {
			"id": "a-6",
			"title": "dropdown-menu-out-mobile",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-6-n",
					"actionTypeId": "STYLE_OPACITY",
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							"useEventTarget": true,
							"id": "620e9742511d44c31912b7cc|b4b6740e-da39-221d-6f6b-2f880cf620cf"
						},
						"value": 0,
						"unit": ""
					}
		...
		"a-11": {
			"id": "a-11",
			"title": "scrolling-nav-bar remake",
		...
		"a-29": {
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"duration": 300,
						"target": {
							"selector": ".nav__transition-block",
							"selectorGuids": ["c432ea43-2f81-495e-8401-6b6838467649"]
						},
						"xValue": -100,
						"xUnit": "%",
						"yUnit": "PX",
				...
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							...
							"selectorGuids": ["c432ea43-2f81-495e-8401-6b6838467651"]
						},
						"xValue": -100,
						"xUnit": "%",
						"yUnit": "PX",
          ...
          "config": {
            ...
            "target": {
              "selector": ".line-1",
              "selectorGuids": ["c432ea43-2f81-495e-8401-6b683846764a"]
            },
            "yValue": 7,
            "xUnit": "PX",
            "yUnit": "PX",
          ...
          "config": {
            ...
            "target": {
              "selector": ".line-2",
              "selectorGuids": ["c432ea43-2f81-495e-8401-6b6838467646"]
            },
            "widthValue": 0,
            "widthUnit": "%",
            "heightUnit": "PX"
          ...
          "config": {
            ...
            "target": {
              "selector": ".line-3",
              "selectorGuids": ["c432ea43-2f81-495e-8401-6b6838467659"]
            },
            "yValue": -7,
            "xUnit": "PX",
            "yUnit": "PX",
      ...
      "actionItemGroups": [{
        "actionItems": [{
          ...
          "config": {
            ...
            "duration": 500,
            "target": {
              "selector": ".nav__transition-block-2",
              "selectorGuids": ["c432ea43-2f81-495e-8401-6b683846764f"]
            },
            "xValue": -100,
            "xUnit": "%",
            "yUnit": "PX",
