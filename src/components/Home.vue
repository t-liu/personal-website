    ...
    <div class="intro">
      <div class="section">
        ...
        <div class="body-text--16">
          ...
          Passion is to get into <strong>cloud computing</strong> and <strong>data engineering</strong>.  Anything to do with backend technology to upskill and learn new technologies.
        </div>
      </div>
    </div>
